...
<template>
  <WelcomeItem>
    ...
    <template #heading>Electrons</template>
  ...
  <WelcomeItem>
    ...
    <template #heading>Hamburger</template>
  ...
  <WelcomeItem>
    ...
    <template #heading>Letter Purple</template>
  ...
  <WelcomeItem>
    ...
    <template #heading>Breaded</template>
  ...
  <WelcomeItem>
    ...
    <template #heading>Squaids</template>
